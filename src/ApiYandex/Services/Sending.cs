...
using Gps2Yandex.ApiYandex.Models;
using Gps2Yandex.ApiYandex.Extensions;

namespace Gps2Yandex.ApiYandex.Services
{
    internal class Sending : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                try
                {
                    Console.WriteLine("Processing data for sending.");
                    ...
                    {
                        Console.WriteLine("No data for sending to yandex.");
                    }
                }
                catch (Exception ex)
                {
        ...
        private void Send(Tracks tracks)
        {
            ...
            Console.WriteLine($"Send data yandex. Response: {result}");
            return;
        }
    }
}
